...
<?php if($game['Game']['is_active'] !== true) { ?>
  <p class="text-error">このゲームは終了しました。</p>
<?php } ?>


<?php echo $this->Form->create(null, array('url' => array('controller' => 'games', 'action' => 'answer', $game['Game']['id']), 'class' => 'form-horizontal')); ?>
  ...
  <?php echo $this->Form->input('Word.game_id', array('label' => false, 'type' => 'hidden', 'value' => $game['Game']['id'])); ?>
  <?php echo $this->Form->input('Word.turn', array('label' => false, 'type' => 'hidden', 'value' => $game['Game']['word_count'] + 1)); ?>
